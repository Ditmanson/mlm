...
class LT_Films_Cast(models.Model):
    film = models.ForeignKey(
        "mlm_app.Film", on_delete=models.DO_NOTHING, null=True
    )
    person = models.ForeignKey(
        "mlm_app.Person", on_delete=models.DO_NOTHING, null=True
    )
...
class LT_Films_Companies(models.Model):
    film = models.ForeignKey("mlm_app.Film", on_delete=models.DO_NOTHING)
    company = models.ForeignKey(
        "mlm_app.Company", on_delete=models.DO_NOTHING
    )
...
class LT_Films_Countries(models.Model):
    ...
    country = models.ForeignKey(
        "mlm_app.Country", on_delete=models.DO_NOTHING
    )
...
class LT_Films_Genres(models.Model):
    film = models.ForeignKey("mlm_app.Film", on_delete=models.DO_NOTHING)
    genre = models.ForeignKey("mlm_app.Genre", on_delete=models.DO_NOTHING)
...
class LT_Films_Keywords(models.Model):
    ...
    keyword = models.ForeignKey(
        "mlm_app.Keyword", on_delete=models.DO_NOTHING
    )
...
class LT_Films_Languages(models.Model):
    ...
    language = models.ForeignKey(
        "mlm_app.Language", on_delete=models.DO_NOTHING
    )


class LT_Viewer_Cosine_Similarity(models.Model):
    viewer_1 = models.ForeignKey(
        "mlm_app.Viewer", on_delete=models.PROTECT, related_name="viewer_1"
    )
    viewer_2 = models.ForeignKey(
        "mlm_app.Viewer", on_delete=models.PROTECT, related_name="viewer_2"
    )
...
class LT_Viewer_Ratings(models.Model):
    viewer = models.ForeignKey(
        "mlm_app.Viewer", on_delete=models.DO_NOTHING, null=True
    )
...
class LT_Viewer_Watchlist(models.Model):
    viewer = models.ForeignKey(
        "mlm_app.Viewer", on_delete=models.DO_NOTHING
    )
    film = models.ForeignKey("mlm_app.Film", on_delete=models.DO_NOTHING)
